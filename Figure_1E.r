...
DMSO = read.table("CEM_DMSO_merged_sort_collapse_average_1MB.bed",header=T)
VP16 = read.table("CEM_VP16_merged_sort_collapse_average_1MB.bed",header=T)
pBQ = read.table("CEM_pBQ_merged_sort_collapse_average_1MB.bed",header=T)
